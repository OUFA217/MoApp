...
class BeginnerPlan extends StatelessWidget {
  const BeginnerPlan({super.key, required this.programName});
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      S.of(context).workOutPlanBeginner,

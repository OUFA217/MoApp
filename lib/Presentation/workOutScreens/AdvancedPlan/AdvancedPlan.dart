...
class AdvancedPlan extends StatelessWidget {
  const AdvancedPlan({super.key, required this.programName});
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      S.of(context).pro2WorkPlanTitle,
                                    ...
                                    SizedBox(height: 8.h),
                                    Text(
                                      S.of(context).pro2WorkPlanSubTitle,

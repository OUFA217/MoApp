...
Future uploadAdvancedData() async {
...
// Loading the json file in the assets
  final String jsonStringDay1 =
      await rootBundle.loadString('assets/workouts/advanced/advancedDay1.json');
...
//  Upload the first Day
  ...
  final String jsonStringDay2 =
      await rootBundle.loadString('assets/workouts/advanced/advancedDay2.json');
  ...
  final String jsonStringDay3 =
      await rootBundle.loadString('assets/workouts/advanced/advancedDay3.json');
  ...
  final String jsonStringDay4 =
      await rootBundle.loadString('assets/workouts/advanced/advancedDay4.json');
  ...
  final String jsonStringDay5 =
      await rootBundle.loadString('assets/workouts/advanced/advancedDay5.json');
  ...
  final String jsonStringDay6 =
      await rootBundle.loadString('assets/workouts/advanced/advancedDay6.json');

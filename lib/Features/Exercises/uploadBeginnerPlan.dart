...
Future uploadBeginnerData() async {
...
// Loading the json file in the assets
  final String jsonStringDay1 =
      await rootBundle.loadString('assets/workouts/beginner/beginnerDay1.json');
...
//  Upload the first Day
  ...
  final String jsonStringDay2 =
      await rootBundle.loadString('assets/workouts/beginner/beginnerDay2.json');
  ...
  final String jsonStringDay3 =
      await rootBundle.loadString('assets/workouts/beginner/beginnerDay3.json');
  ...
  final String jsonStringDay4 =
      await rootBundle.loadString('assets/workouts/beginner/beginnerDay4.json');
  ...
  final String jsonStringDay5 =
      await rootBundle.loadString('assets/workouts/beginner/beginnerDay5.json');

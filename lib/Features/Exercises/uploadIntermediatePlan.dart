...
Future uploadIntermediateData() async {
...
// Loading the json file in the assets
  final String jsonStringDay1 = await rootBundle
      .loadString('assets/workouts/intermediate/intermediateDay1.json');
...
//  Upload the first Day
  ...
  // Loading the json file in the assets
  final String jsonStringDay2 = await rootBundle
      .loadString('assets/workouts/intermediate/intermediateDay2.json');
  ...
  final String jsonStringDay3 = await rootBundle
      .loadString('assets/workouts/intermediate/intermediateDay3.json');
  ...
  // //
  // Loading the json file in the assets
  final String jsonStringDay4 = await rootBundle
      .loadString('assets/workouts/intermediate/intermediateDay4.json');
  ...
  // //
  // Loading the json file in the assets
  final String jsonStringDay5 = await rootBundle
      .loadString('assets/workouts/intermediate/intermediateDay5.json');
